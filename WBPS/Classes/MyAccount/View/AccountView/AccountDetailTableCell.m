...
@interface AccountDetailTableCell ()
/** 订单编号 */
...
@implementation AccountDetailTableCell
...
- (void)setModel:(DetailModel *)model{
    _model = model;
    self.orderNo.text = _model.xmtype;
    self.orderTime.text = _model.billdate;
    self.money.text = _model.accfs;
