...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[AnnouncementTableCell class] forCellReuseIdentifier:CellID];
...
- (void)downPullData{
    ...
    [[NetWorkingManager sharedManager]POSTWithParameters:upData success:^(id responseObject) {
        ...
        self.index = 1;
        [self.dataArray addObjectsFromArray:[AnnouncementModel mj_objectArrayWithKeyValuesArray:[responseObject objectForKey:@"msg"]]];
...
- (void)upPullData{
    ...
    [[NetWorkingManager sharedManager]POSTWithParameters:upData success:^(id responseObject) {
        ...
        NSArray * array = [AnnouncementModel mj_objectArrayWithKeyValuesArray:[responseObject objectForKey:@"msg"]];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGSize size = [QLRegularTool convertToString:model.noticecontent stringFont:15 wide:SCREEN_WIDTH-40 high:999];
    CGFloat height = size.height + 215;
    return height;
}
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    AnnouncementTableCell * cell = [tableView dequeueReusableCellWithIdentifier:CellID];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    AnnouncementModel * model =self.dataArray[indexPath.row];
    AnnouncementWebInfoController * announcementVc = [[AnnouncementWebInfoController alloc]init];
    announcementVc.infoUrl = model.noticeurl;
    announcementVc.vcTitle = model.noticetitle;
