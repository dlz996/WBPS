//
//  QLClippingImageViewController.m
//  QiongLiao
//
...
#import "QLClippingImageViewController.h"

@interface QLClippingImageViewController ()
@property (nonatomic, assign)CGRect circularFrame;//裁剪框的frame
@end

@implementation QLClippingImageViewController
{
    CGFloat _layerY;
}
...
-(void)drawClipPath:(ClipType )clipType
{
    ...
    UIBezierPath * path= [UIBezierPath bezierPathWithRect:CGRectMake(0, _layerY, ScreenWidth, ScreenHeight)];
    ...
    if(clipType == CIRCULARCLIP)
    {
        ...
        [path appendPath:[UIBezierPath bezierPathWithRect:self.rectangleFrame]];
        self.circularFrame = self.rectangleFrame;
    }
