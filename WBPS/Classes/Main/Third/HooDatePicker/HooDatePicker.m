...
- (instancetype)initWithSuperView:(UIView*)superView {
    ...
    if (self = [super initWithFrame:CGRectMake(50, 100, SCREEN_WIDTH-100, kHooDatePickerHeight)]) {
...
//        datePicker.backgroundColor = [UIColor clearColor];
       ...
       self.scrollViewYears.backgroundColor = [UIColor clearColor];
        self.scrollViewMonths.backgroundColor = [UIColor clearColor];
        self.backgroundColor = [UIColor clearColor];


        
        self.highlightColor = Black_Color;
...
//        self.frame = CGRectMake(50, -200, SCREEN_WIDTH-100, kHooDatePickerHeight);
//        _isInitialized = YES;
//    }
